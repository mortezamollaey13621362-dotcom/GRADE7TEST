...
export class LessonManager {
    ...
    async loadConfig() {
        this.config = {
            ...
            totalLessons: 8,
            lessons: [
                {id: "1", title: "He is a manager.", subtitle: "معرفی افراد و مشاغل", icon: "👨‍💼", path: "data/lesson1"},
                {id: "2", title: "My family", subtitle: "خانواده و روابط", icon: "👨‍👩‍👧‍👦", path: "data/lesson2"},
                {id: "3", title: "At school", subtitle: "محیط مدرسه", icon: "🏫", path: "data/lesson3"},
                {id: "4", title: "My house", subtitle: "خانه و اتاق‌ها", icon: "🏠", path: "data/lesson4"},
                {id: "5", title: "Daily routines", subtitle: "کارهای روزمره", icon: "🕒", path: "data/lesson5"},
                {id: "6", title: "Food and drinks", subtitle: "غذا و نوشیدنی‌ها", icon: "🍎", path: "data/lesson6"},
                {id: "7", title: "Hobbies", subtitle: "سرگرمی‌ها و علاقمندی‌ها", icon: "⚽", path: "data/lesson7"},
                {id: "8", title: "Weather", subtitle: "آب و هوا و فصل‌ها", icon: "☀️", path: "data/lesson8"}
            ]
        };
        return this.config;
    }
